        ...
        for attempt in range(self.config.max_retries):
            try:
                ...
                if attempt < self.config.max_retries - 1:
                    ...
                    # Don't raise here, let the loop finish and raise last_error
...
# settings object is assumed to have OPENAI_API_KEY and ANTHROPIC_API_KEY
# If keys are missing, these will fail at runtime, which is expected if not configured.
